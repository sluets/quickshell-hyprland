                ...
                spacing: Theme.spacingSmall
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                color: clearMouse.containsMouse ? Theme.colorHover : Theme.colorControl
                            ...
                            ListView {
                                ...
                                delegate: Rectangle {
                                    ...
                                    readonly property real scrollbarWidth:
                                        list.ScrollBar.vertical.visible
                                            ? list.ScrollBar.vertical.width : 0

                                    width: list.width
                                    height: binary ? 88 : Math.max(
                                        54,
                                    ...
                                    Rectangle {
                                        ...
                                        x: Theme.spacingMedium
                                            + parent.scrollbarWidth / 2
                                        width: parent.width
                                            - Theme.spacingMedium * 2
                                            - parent.scrollbarWidth
