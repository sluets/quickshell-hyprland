...
ColumnLayout {
    ...
    SettingsComponents.SettingsSectionHeader { title: "Picker Placement" }
    SettingsComponents.SettingsCard {
        contentSpacing: Theme.spacingSmall

        SettingsComponents.OptionPickerRow {
            label: "Placement"
            description: "Attached connects to the bar; centered opens over the focused monitor."
    ...
    SettingsComponents.SettingsSectionHeader { title: "Wallpaper Library" }
    SettingsComponents.SettingsCard {
        contentSpacing: Theme.spacingSmall
    ...
    SettingsComponents.SettingsSectionHeader { title: "Wallpaper Transition" }
    SettingsComponents.SettingsCard {
        contentSpacing: Theme.spacingSmall
