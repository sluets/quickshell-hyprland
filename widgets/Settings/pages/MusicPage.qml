...
ColumnLayout {
    ...
    Text {
        ...
        text: "CAVA can capture MPD only or the complete PipeWire output. Changes apply without restarting Quickshell; an open music window briefly restarts only its visualizer process."
    ...
    Text {
        Layout.fillWidth: true
        text: "Lower smoothing reacts faster and looks noisier. The approved terminal-like baseline is 77."
        color: Theme.colorMuted
        font.family: Theme.fontFamily
