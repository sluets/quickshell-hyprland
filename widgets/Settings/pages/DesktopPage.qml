...
ColumnLayout {
    ...
    SettingsComponents.SettingsSectionHeader { title: "Bar Clock" }
    ...
    SettingsComponents.SettingsSectionHeader { title: "Desktop Clock" }
    SettingsComponents.SettingsCard {
        contentSpacing: Theme.spacingSmall
    ...
    SettingsComponents.SettingsSectionHeader { title: "Display" }
    SettingsComponents.SettingsCard {
        contentSpacing: Theme.spacingSmall
    ...
    SettingsComponents.SettingsSectionHeader { title: "Colors" }
    SettingsComponents.SettingsCard {
        contentSpacing: Theme.spacingSmall
