...
//=============================================================================
//
// WINDOW MECHANICS: identical recipe to PowerScreen.qml (the proven
// pattern) — fullscreen transparent PanelWindow on the Overlay layer,
// exclusiveZone 0, reveal animation, HyprlandFocusGrab with
// click-outside + Escape to close. Read PowerScreen's DESIGN NOTES
// for the reasoning; it isn't repeated here.
//
...
FloatingWindow {
    ...
    */
    ...
    Binding {
        ...
        value: root._qColorToHyprHex(Theme.colorAccent)
    }
    // Preserve the theme's optional second border color and gradient angle
    // for Hyprland's active window border. This is separate from the removed
    // QML window border: Hyprland alone draws the actual outer border.
    Binding {
        target: ConfigManager
        property: "hyprActiveBorderThemeGrad"
        value: Theme.barBorderColor2.a > 0.001
    }
    Binding {
        target: ConfigManager
        property: "hyprActiveBorderThemeHex2"
        value: Theme.barBorderColor2.a > 0.001
            ? root._qColorToHyprHex(Theme.barBorderColor2) : ""
    }
    Binding {
        target: ConfigManager
        property: "hyprActiveBorderThemeAngle"
        value: Theme.barBorderGradientAngle
    }
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                radius: Theme.radiusMedium
                bottomLeftRadius: root.themeDropdownOpen ? 0 : -1
                bottomRightRadius: root.themeDropdownOpen ? 0 : -1
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        text: (root.stagedTheme !== null ? "● " : "") + root.shownTheme
                        color: root.stagedTheme !== null ? Theme.colorAccent : Theme.colorForeground
                        font.family: Theme.fontFamily
                        font.pixelSize: Theme.fontSize
                    }
                    Text {
                        text: root.themeDropdownOpen ? "▾" : "▸"
                        color: Theme.colorMuted
                        font.family: Theme.fontFamily
                        font.pixelSize: Theme.fontSize
                    }
                ...
                MouseArea {
                    ...
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
                        root.themeDropdownOpen = !root.themeDropdownOpen;
                        if (root.themeDropdownOpen) {
                            root.fontFamilyDropdownOpen = false;
                            root.wallpaperTransitionTypeDropdownOpen = false;
                        }
                    }
            ...
            SettingsComponents.StepperRow {
                valueText: root.shownFontScale.toFixed(1) + "×"
                staged: root.stagedFontScale !== null
                onMinus: root.stagedFontScale =
                    Math.max(0.8, Math.round((root.shownFontScale - 0.1) * 10) / 10)
                onPlus: root.stagedFontScale =
                    Math.min(2.5, Math.round((root.shownFontScale + 0.1) * 10) / 10)
            }
            ...
            Rectangle {
                ...
                radius: Theme.radiusMedium
                bottomLeftRadius: root.fontFamilyDropdownOpen ? 0 : -1
                bottomRightRadius: root.fontFamilyDropdownOpen ? 0 : -1
                ...
                RowLayout {
                    ...
                    Text {
                        Layout.fillWidth: true
                        elide: Text.ElideRight
                        text: (root.stagedFontFamilyOverride !== null ? "● " : "")
                            + (root.shownFontFamilyOverride === "" ? "(Theme Default)" : root.shownFontFamilyOverride)
                        color: root.stagedFontFamilyOverride !== null ? Theme.colorAccent : Theme.colorForeground
                        font.family: Theme.fontFamily
                        font.pixelSize: Theme.fontSize
                    }
                    Text {
                        text: root.fontFamilyDropdownOpen ? "▾" : "▸"
                        color: Theme.colorMuted
                        font.family: Theme.fontFamily
                        font.pixelSize: Theme.fontSize
                    }
                ...
                MouseArea {
                    ...
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
                        root.fontFamilyDropdownOpen = !root.fontFamilyDropdownOpen;
                        if (root.fontFamilyDropdownOpen) {
                            root.themeDropdownOpen = false;
                            root.wallpaperTransitionTypeDropdownOpen = false;
                        }
                    }
            ...
            SettingsComponents.ToggleSettingRow {
                ...
                value: root.shownBarPaddingTopOverride >= 0
                staged: root.stagedBarPaddingTopOverride !== null
                    || root.stagedBarPaddingSideOverride !== null
                    || root.stagedBarPaddingBottomOverride !== null
                onToggled: {
                    if (root.shownBarPaddingTopOverride >= 0) {
                        ...
                        root.stagedBarPaddingTopOverride = -1;
                        root.stagedBarPaddingSideOverride = -1;
                        root.stagedBarPaddingBottomOverride = UserPrefs.barPaddingBottomOffSentinel;
                    } else {
                        ...
                        root.stagedBarPaddingTopOverride = Theme.barPaddingTop;
                        root.stagedBarPaddingSideOverride = Theme.barPaddingSide;
                        root.stagedBarPaddingBottomOverride = Theme.barPaddingBottom;
                    }
                }
            }
            ...
            SettingsComponents.StepperRow {
                visible: root.shownBarPaddingTopOverride >= 0
                label: "Top"
                valueText: root.shownBarPaddingTopOverride + " px"
                staged: root.stagedBarPaddingTopOverride !== null
                onMinus: root.stagedBarPaddingTopOverride =
                    Math.max(0, root.shownBarPaddingTopOverride - 1)
                onPlus: root.stagedBarPaddingTopOverride =
                    Math.min(200, root.shownBarPaddingTopOverride + 1)
            }

            SettingsComponents.StepperRow {
                visible: root.shownBarPaddingTopOverride >= 0
                label: "Sides"
                valueText: root.shownBarPaddingSideOverride + " px"
                staged: root.stagedBarPaddingSideOverride !== null
                onMinus: root.stagedBarPaddingSideOverride =
                    Math.max(0, root.shownBarPaddingSideOverride - 1)
                onPlus: root.stagedBarPaddingSideOverride =
                    Math.min(200, root.shownBarPaddingSideOverride + 1)
            }
            ...
            SettingsComponents.StepperRow {
                visible: root.shownBarPaddingTopOverride >= 0
                label: "Bottom"
                valueText: root.shownBarPaddingBottomOverride + " px"
                staged: root.stagedBarPaddingBottomOverride !== null
                onMinus: root.stagedBarPaddingBottomOverride =
                    Math.max(-100, root.shownBarPaddingBottomOverride - 1)
                onPlus: root.stagedBarPaddingBottomOverride =
                    Math.min(200, root.shownBarPaddingBottomOverride + 1)
            }
            ...
            SettingsComponents.ToggleSettingRow {
                label: "Custom width"
                value: root.shownBarBorderWidthOverride >= 0
                staged: root.stagedBarBorderWidthOverride !== null
                // Turning ON seeds the override with the current
                // effective width so nothing visibly jumps; OFF is -1,
                // "follow theme".
                onToggled: root.stagedBarBorderWidthOverride =
                    root.shownBarBorderWidthOverride >= 0 ? -1 : Theme.barBorderWidth
            }

            SettingsComponents.StepperRow {
                visible: root.shownBarBorderWidthOverride >= 0
                label: "Width"
                valueText: root.shownBarBorderWidthOverride + " px"
                staged: root.stagedBarBorderWidthOverride !== null
                onMinus: root.stagedBarBorderWidthOverride =
                    Math.max(0, root.shownBarBorderWidthOverride - 1)
                onPlus: root.stagedBarBorderWidthOverride =
                    Math.min(12, root.shownBarBorderWidthOverride + 1)
            }

            SettingsComponents.ToggleSettingRow {
                label: "Use theme color"
                value: root.shownBarBorderUseThemeColor
                staged: root.stagedBarBorderUseThemeColor !== null
                onToggled: root.stagedBarBorderUseThemeColor =
                    !root.shownBarBorderUseThemeColor
            }
            ...
            SettingsComponents.HexColorRow {
                ...
                visible: !root.shownBarBorderUseThemeColor
                shownValue: root.shownBarBorderCustomColor
                staged: root.stagedBarBorderCustomColor !== null
                onHexStaged: t => root.stagedBarBorderCustomColor = t
            }
            ...
            Rectangle {
                ...
                radius: Theme.radiusMedium
                bottomLeftRadius: root.wallpaperTransitionTypeDropdownOpen ? 0 : -1
                bottomRightRadius: root.wallpaperTransitionTypeDropdownOpen ? 0 : -1
                ...
                RowLayout {
                    ...
                    Text {
                        Layout.fillWidth: true
                        elide: Text.ElideRight
                        text: (root.stagedWallpaperTransitionType !== null ? "● " : "") + root.shownWallpaperTransitionType
                        color: root.stagedWallpaperTransitionType !== null ? Theme.colorAccent : Theme.colorForeground
                        font.family: Theme.fontFamily
                        font.pixelSize: Theme.fontSize
                    }
                    Text {
                        text: root.wallpaperTransitionTypeDropdownOpen ? "▾" : "▸"
                        color: Theme.colorMuted
                        font.family: Theme.fontFamily
                        font.pixelSize: Theme.fontSize
                    }
                ...
                MouseArea {
                    ...
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
                        root.wallpaperTransitionTypeDropdownOpen = !root.wallpaperTransitionTypeDropdownOpen;
                        if (root.wallpaperTransitionTypeDropdownOpen) {
                            root.themeDropdownOpen = false;
                            root.fontFamilyDropdownOpen = false;
                        }
                    }
            ...
            SettingsComponents.OptionPickerRow {
                visible: root.shownWallpaperTransitionType === "grow"
                      || root.shownWallpaperTransitionType === "outer"
                label: "Position"
                options: root.wallpaperTransitionPosOptions
                shownValue: root.shownWallpaperTransitionPos
                staged: root.stagedWallpaperTransitionPos !== null
                onPicked: v => root.stagedWallpaperTransitionPos = v
            }

            SettingsComponents.StepperRow {
                label: "Duration"
                valueText: root.shownWallpaperTransitionDuration.toFixed(1) + "s"
                staged: root.stagedWallpaperTransitionDuration !== null
                onMinus: root.stagedWallpaperTransitionDuration =
                    Math.max(0.1, Math.round((root.shownWallpaperTransitionDuration - 0.1) * 10) / 10)
                onPlus: root.stagedWallpaperTransitionDuration =
                    Math.min(5.0, Math.round((root.shownWallpaperTransitionDuration + 0.1) * 10) / 10)
            }

            SettingsComponents.StepperRow {
                label: "FPS"
                valueText: String(root.shownWallpaperTransitionFps)
                staged: root.stagedWallpaperTransitionFps !== null
                onMinus: root.stagedWallpaperTransitionFps =
                    Math.max(1, root.shownWallpaperTransitionFps - 5)
                onPlus: root.stagedWallpaperTransitionFps =
                    Math.min(240, root.shownWallpaperTransitionFps + 5)
            }

            SettingsComponents.StepperRow {
                visible: root.shownWallpaperTransitionType === "wipe"
                      || root.shownWallpaperTransitionType === "wave"
                label: "Angle"
                valueText: Math.round(root.shownWallpaperTransitionAngle) + "°"
                staged: root.stagedWallpaperTransitionAngle !== null
                onMinus: root.stagedWallpaperTransitionAngle =
                    (((root.shownWallpaperTransitionAngle - 15) % 360) + 360) % 360
                onPlus: root.stagedWallpaperTransitionAngle =
                    (((root.shownWallpaperTransitionAngle + 15) % 360) + 360) % 360
            }
            ...
            // ================ NOTIFICATIONS PAGE ================
            // Born from the maintainer's THOUGHTS.txt wishlist,
            // 2026-07-09: hide app name / icon size / font size,
            // plus body line count (the real truncation culprit was
            // the app name sharing the summary's row — see
            // NotificationPopups.qml's revision notes).
            ColumnLayout {
                Layout.fillWidth: true
                spacing: Theme.spacingMedium
                ...
                SettingsComponents.ToggleSettingRow {
                    label: "Show App Name"
                    value: root.shownNotifShowAppName
                    staged: root.stagedNotifShowAppName !== null
                    onToggled: root.stagedNotifShowAppName = !root.shownNotifShowAppName
                }

                SettingsComponents.StepperRow {
                    label: "Icon Size"
                    valueText: root.shownNotifIconSize + " px"
                    staged: root.stagedNotifIconSize !== null
                    onMinus: root.stagedNotifIconSize =
                        Math.max(24, root.shownNotifIconSize - 8)
                    onPlus: root.stagedNotifIconSize =
                        Math.min(96, root.shownNotifIconSize + 8)
                }

                SettingsComponents.StepperRow {
                    label: "Body Lines"
                    valueText: String(root.shownNotifBodyLines)
                    staged: root.stagedNotifBodyLines !== null
                    onMinus: root.stagedNotifBodyLines =
                        Math.max(1, root.shownNotifBodyLines - 1)
                    onPlus: root.stagedNotifBodyLines =
                        Math.min(10, root.shownNotifBodyLines + 1)
                }

                SettingsComponents.StepperRow {
                    label: "Font Scale"
                    valueText: root.shownNotifFontScale.toFixed(1) + "×"
                    staged: root.stagedNotifFontScale !== null
                    onMinus: root.stagedNotifFontScale =
                        Math.max(0.8, Math.round((root.shownNotifFontScale - 0.1) * 10) / 10)
                    onPlus: root.stagedNotifFontScale =
                        Math.min(2.0, Math.round((root.shownNotifFontScale + 0.1) * 10) / 10)
                }
                ...
                SettingsComponents.OptionPickerRow {
                    label: "Corner"
                    options: root.notifCornerOptions
                    shownValue: root.shownNotifCorner
                    staged: root.stagedNotifCorner !== null
                    onPicked: v => root.stagedNotifCorner = v
                }

                SettingsComponents.StepperRow {
                    label: "Offset X"
                    valueText: root.shownNotifOffsetX + " px"
                    staged: root.stagedNotifOffsetX !== null
                    onMinus: root.stagedNotifOffsetX =
                        Math.max(-500, root.shownNotifOffsetX - 5)
                    onPlus: root.stagedNotifOffsetX =
                        Math.min(2000, root.shownNotifOffsetX + 5)
                }

                SettingsComponents.StepperRow {
                    label: "Offset Y"
                    valueText: root.shownNotifOffsetY + " px"
                    staged: root.stagedNotifOffsetY !== null
                    onMinus: root.stagedNotifOffsetY =
                        Math.max(-500, root.shownNotifOffsetY - 5)
                    onPlus: root.stagedNotifOffsetY =
                        Math.min(2000, root.shownNotifOffsetY + 5)
                }

                // Test button — fires a real notification through the
                // shell's own daemon via notify-send, so what appears
                // is exactly what any app's popup will look like.
                // Deliberately shows APPLIED settings, not staged ones
                // (the window's staged-not-live rule): stage, Apply,
                // THEN test. The hint below says so.
                RowLayout {
                    Layout.fillWidth: true
                    spacing: Theme.spacingMedium
            ...
            // ================ DESKTOP PAGE ================
            // The desktop clock's controls (thoughts_next_session.txt,
            // 2026-07-11): everything the widget reads from UserPrefs.
            // Same staged/Apply transaction as every other page. The
            // monitor picker's cells come from LIVE Quickshell.screens
            // (see root.monitorOptions) — a saved name for an
            // unplugged monitor still applies, it just has no cell to
            // highlight until the monitor returns.
            ColumnLayout {
                Layout.fillWidth: true
                spacing: Theme.spacingMedium
                ...
                SettingsComponents.ToggleSettingRow {
                    label: "Enabled"
                    value: root.shownDesktopClockEnabled
                    staged: root.stagedDesktopClockEnabled !== null
                    onToggled: root.stagedDesktopClockEnabled =
                        !root.shownDesktopClockEnabled
                }

                SettingsComponents.OptionPickerRow {
                    label: "Corner"
                    options: root.clockCornerOptions
                    shownValue: root.shownDesktopClockCorner
                    staged: root.stagedDesktopClockCorner !== null
                    onPicked: v => root.stagedDesktopClockCorner = v
                }

                SettingsComponents.StepperRow {
                    label: "Offset X"
                    valueText: root.shownDesktopClockOffsetX + " px"
                    staged: root.stagedDesktopClockOffsetX !== null
                    onMinus: root.stagedDesktopClockOffsetX =
                        Math.max(-500, root.shownDesktopClockOffsetX - 5)
                    onPlus: root.stagedDesktopClockOffsetX =
                        Math.min(2000, root.shownDesktopClockOffsetX + 5)
                }

                SettingsComponents.StepperRow {
                    label: "Offset Y"
                    valueText: root.shownDesktopClockOffsetY + " px"
                    staged: root.stagedDesktopClockOffsetY !== null
                    onMinus: root.stagedDesktopClockOffsetY =
                        Math.max(-500, root.shownDesktopClockOffsetY - 5)
                    onPlus: root.stagedDesktopClockOffsetY =
                        Math.min(2000, root.shownDesktopClockOffsetY + 5)
                }

                SettingsComponents.OptionPickerRow {
                    label: "Monitor"
                    options: root.monitorOptions
                    shownValue: root.shownDesktopClockMonitor
                    staged: root.stagedDesktopClockMonitor !== null
                    onPicked: v => root.stagedDesktopClockMonitor = v
                }
                ...
                SettingsComponents.ToggleSettingRow {
                    label: "Use theme color"
                    value: root.shownDesktopClockUseThemeColor
                    staged: root.stagedDesktopClockUseThemeColor !== null
                    onToggled: root.stagedDesktopClockUseThemeColor =
                        !root.shownDesktopClockUseThemeColor
                }

                SettingsComponents.HexColorRow {
                    colorPickerHost: root
                    visible: !root.shownDesktopClockUseThemeColor
                    label: "Text hex"
                    shownValue: root.shownDesktopClockCustomColor
                    staged: root.stagedDesktopClockCustomColor !== null
                    onHexStaged: t => root.stagedDesktopClockCustomColor = t
                }

                SettingsComponents.ToggleSettingRow {
                    label: "Shadow"
                    value: root.shownDesktopClockShadowEnabled
                    staged: root.stagedDesktopClockShadowEnabled !== null
                    onToggled: root.stagedDesktopClockShadowEnabled =
                        !root.shownDesktopClockShadowEnabled
                }

                SettingsComponents.ToggleSettingRow {
                    visible: root.shownDesktopClockShadowEnabled
                    label: "Shadow uses theme color"
                    value: root.shownDesktopClockShadowUseThemeColor
                    staged: root.stagedDesktopClockShadowUseThemeColor !== null
                    onToggled: root.stagedDesktopClockShadowUseThemeColor =
                        !root.shownDesktopClockShadowUseThemeColor
                }
                ...
                SettingsComponents.HexColorRow {
                    ...
                    visible: root.shownDesktopClockShadowEnabled
                             && !root.shownDesktopClockShadowUseThemeColor
                    label: "Shadow hex"
                    shownValue: root.shownDesktopClockShadowCustomColor
                    staged: root.stagedDesktopClockShadowCustomColor !== null
                    onHexStaged: t => root.stagedDesktopClockShadowCustomColor = t
                }
        ...
        Rectangle {
            ...
            readonly property point anchorPos: root.themeDropdownOpen
                ? themeDropdownButton.mapToItem(card, 0, 0)
                : Qt.point(0, 0)
            ...
            y: anchorPos.y + themeDropdownButton.height - 1
            width: Math.min(themeDropdownButton.width, card.width - x - root.pageScrollGutter - Theme.spacingLarge)
        ...
        Rectangle {
            ...
            readonly property point anchorPos: root.fontFamilyDropdownOpen
                ? fontDropdownButton.mapToItem(card, 0, 0)
                : Qt.point(0, 0)
            readonly property int rowHeight: Theme.fontSize + Theme.spacingSmall * 2 + 2
            readonly property int visibleRows: Math.min(root.fontFamilyOptions.length, 6)

            x: anchorPos.x
            y: anchorPos.y + fontDropdownButton.height - 1
            width: Math.min(fontDropdownButton.width, card.width - x - root.pageScrollGutter - Theme.spacingLarge)
            height: visibleRows * rowHeight + Theme.spacingSmall * 2
            radius: Theme.radiusMedium
            topLeftRadius: 0
            topRightRadius: 0
        ...
        Rectangle {
            ...
            readonly property point anchorPos: root.wallpaperTransitionTypeDropdownOpen
                ? wallpaperTransitionTypeDropdownButton.mapToItem(card, 0, 0)
                : Qt.point(0, 0)
            readonly property int rowHeight: Theme.fontSize + Theme.spacingSmall * 2 + 2
            readonly property int visibleRows: Math.min(root.wallpaperTransitionTypeOptions.length, 6)

            x: anchorPos.x
            y: anchorPos.y + wallpaperTransitionTypeDropdownButton.height - 1
            width: Math.min(wallpaperTransitionTypeDropdownButton.width, card.width - x - root.pageScrollGutter - Theme.spacingLarge)
            height: visibleRows * rowHeight + Theme.spacingSmall * 2
            radius: Theme.radiusMedium
            topLeftRadius: 0
            topRightRadius: 0
