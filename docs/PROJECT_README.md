...
**For a full install** — every dependency, the wallpaper/thumbnail
setup, fonts, config, compositor integration, and troubleshooting —
follow **`docs/SETUP_GUIDE.md`**. It's written to be followed by a human
end-to-end, and also to bring an AI up to speed if you hand it the repo
and ask for help.
